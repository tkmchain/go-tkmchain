...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({name: 'hash', call: 'tkmdomain_domainHash', params: 1}),
		new web3._extend.Method({name: 'mailboxHash', call: 'tkmdomain_mailboxHash', params: 2}),
		new web3._extend.Method({name: 'registration', call: 'tkmdomain_registration', params: 1}),
