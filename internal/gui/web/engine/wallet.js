...
async function Ug({ rpcURL: e, rpcToken: t }) {
...
async function Wg(e, { walletURL: t, rpcToken: n }) {
	return Gg("validate", { recipient: e }, {
		walletURL: t,
		rpcToken: n
	});
}
async function Gg(e, t, { walletURL: n, rpcToken: r }) {
...
function qg(e) {
	return Kg("identity", e);
}
function Jg(e) {
	return Kg("viewkeys", e);
}
function Yg(e) {
	return Kg("scan", e);
}
...
async function Qg(e) {
	let t = Pg();
	try {
		return await Kg("register-stamp", e, { requestId: e.requestId });
	} finally {
		t();
	}
}
