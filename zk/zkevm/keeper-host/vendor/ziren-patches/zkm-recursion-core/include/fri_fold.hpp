...
namespace zkm_recursion_core_sys::fri_fold {
template <class F>
__ZKM_HOSTDEV__ void event_to_row(const FriFoldEvent<F>& event,
                                  FriFoldCols<F>& cols) {
...
template <class F>
__ZKM_HOSTDEV__ void instr_to_row(const FriFoldInstrFFI<F>& instr, size_t i,
