...
namespace zkm_recursion_core_sys::exp_reverse_bits {
template <class F>
__ZKM_HOSTDEV__ void event_to_row(const ExpReverseBitsEventFFI<F>& event,
...
template <class F>
__ZKM_HOSTDEV__ void instr_to_row(const ExpReverseBitsInstrFFI<F>& instr,
                                  size_t i, size_t len,
