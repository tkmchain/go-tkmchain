...
namespace zkm_recursion_core_sys::batch_fri {
template <class F>
__ZKM_HOSTDEV__ void event_to_row(const BatchFRIEvent<F>& event,
                                  BatchFRICols<F>& cols) {
...
template <class F>
__ZKM_HOSTDEV__ void instr_to_row(const BatchFRIInstrFFI<F>& instr,
