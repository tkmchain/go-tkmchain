...
var (
	// RandomXGenesisHash is the genesis hash for the RandomX chain
...
// ============================================================
// CLIQUE CONSENSUS CONFIG (Optional)
// ============================================================
...
type ChainConfig struct {
	...
	// Block-based forks (all enabled at genesis for RandomX)
	...
	// Time-based forks (all enabled at genesis for RandomX)
...
// ============================================================
// RANDOMX CHAIN CONFIGURATION
// ============================================================

// RandomXChainConfig is the chain parameters for RandomX mainnet.
var RandomXChainConfig = &ChainConfig{
	ChainID: big.NewInt(8979),

	// All block-based forks enabled at genesis (block 0)
	...
	// All time-based forks enabled at genesis (timestamp 0)
...
// These aliases exist for compatibility with existing code.
// All RandomX chains should use RandomXChainConfig.
var (
	...
	// Clique configuration for testing
...
// IsMuirGlacier returns false for RandomX (not activated).
...
func (c *ChainConfig) ActiveSystemContracts(time uint64) map[string]common.Address {
	...
	if fork >= forks.Prague {
		// Add Prague system contracts here if needed
