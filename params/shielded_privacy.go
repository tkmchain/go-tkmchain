...
const (
	...
	mainnetShieldedGroth16V2VKHex        = ""
...
// MainnetShieldedGroth16V2VerifyingKey matches the recipient-bound V2 circuit.
var MainnetShieldedGroth16V2VerifyingKey = mustDecodeOptionalHex(mainnetShieldedGroth16V2VKHex)

// IsMainnetShieldedV2 reports whether recipient-bound V2 envelopes are active.
...
func (c *ChainConfig) CheckMainnetShieldedPrivacyReady() error {
	...
	if err := validateShieldedGroth16VK(MainnetShieldedGroth16RecoveryVerifyingKey, "mainnet recovery shielded Groth16 verifying key", shieldedGroth16PublicInputs); err != nil {
		return err
	}
	return validateShieldedGroth16VK(MainnetShieldedGroth16V2VerifyingKey, "mainnet recipient-bound V2 shielded Groth16 verifying key", shieldedGroth16PublicInputs+1)
}

func validateShieldedGroth16VK(encoded []byte, name string, publicInputs ...int) error {
	if len(encoded) == 0 {
	...
	expected := shieldedGroth16PublicInputs
	if len(publicInputs) != 0 {
		expected = publicInputs[0]
	}
	if len(envelope.IC) != expected+1 {
		return fmt.Errorf("%s has %d IC points, want %d", name, len(envelope.IC), expected+1)
	}
